...
filename = '../preprocessed_data/'+args.domain+'/generated.p'

if os.path.exists(filename) :
    f = open(filename, 'rb')
    vocab, train_x, test_x, overall_maxlen = pickle.load(f)
    f.close()
else :
    ...
    f = open('../preprocessed_data/'+args.domain+'/generated.p', 'wb')
    pickle.dump([vocab, train_x, test_x, overall_maxlen], f)
    f.close()
