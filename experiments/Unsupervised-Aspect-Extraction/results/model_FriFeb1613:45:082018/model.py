...
class EmbedSentence(nn.Module) :
    ...
    def forward(self, sentence, imask, reconstruct=False) :
        ...
        avg_embedding = torch.mean(embedding, dim=1) #(B, E)
        ...
        return mix, attn_weights, p_t, r_s
...
class Model() :
    def __init__(self, **kwargs) :
        ...
        self.model = EmbedSentence(self.lang_1['vocab_size'], self.lang_1['word_dim'], 20, pre_embed=self.lang_1['embeddings'])
        self.model.cuda()
